...
void TrainView::draw()
{
	...
	if (gladLoadGL())
	{
		...
		if (!this->skyboxShader) {
			...
			this->skyboxShader = new Shader("./src/shaders/skybox.vert",
				nullptr, nullptr, nullptr,
		...
		if (!this->tileShader) {
			...
			this->tileShader = new Shader("./src/shaders/tiles.vert",
				nullptr, nullptr, nullptr,
			...
			tileTexture = loadTexture("./Images/tiles.jpg");
		...
		if (!this->fillShader) {
			...
			fillShader = new Shader("./src/shaders/fill.vert", NULL, NULL, NULL, "./src/shaders/fill.frag");
		...
		if (!this->waterShader) {
			...
			waterShader = new Shader("./src/shaders/water.vert", NULL, NULL, NULL, "./src/shaders/water.frag");
			std::string path = "./Images/waves/";
			for (int i = 0; i < 200; ++i) {
		...
		if (!this->watersinShader) {
			...
			watersinShader = new Shader("./src/shaders/waterSin.vert", NULL, NULL, NULL, "./src/shaders/waterSin.frag");
		...
		if (!this->frameShader) {
			...
			frameShader = new Shader("./src/shaders/frame.vert", NULL, NULL, NULL, "./src/shaders/frame.frag");
		...
		if (!this->pickShader) {
			...
			pickShader = new Shader("./src/shaders/pick.vert", NULL, NULL, NULL, "./src/shaders/pick.frag");
		...
		if (!this->computeShader) {
			computeShader = new Shader("./src/shaders/compute.comp");
		...
		if (!this->pointShader) {
			...
			pointShader = new Shader("./src/shaders/point.vert", NULL, NULL, NULL, "./src/shaders/point.frag");
