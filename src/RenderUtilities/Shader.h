...
public:
	...
	Shader(const GLchar* compute)
	{
		std::vector<GLuint> shaders;
		shaders.push_back(this->compileShader(GL_COMPUTE_SHADER, this->readCode(compute).c_str()));
		this->type = (Shader::Type)(this->type | Type::COMPUTER_SHADER);
